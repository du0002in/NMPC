...
[est_xtmpl,est_ytmpl,est_xtmpr,est_ytmpr]=Check_next_lane_position(-xzthetapredict(1),xzthetapredict(2),pi-xzthetapredict(3),Phai,H,pre_abc1,leftrightlane,lane_width, ...
    dist_left_right,L_wheel_cam,Tpix2cam_left, Tpix2cam_right);
